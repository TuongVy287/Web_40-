  ...
  <div class="modal-overlay">
    ...
    <div class="modal-container">
      ...
      <div class="form-group">
        ...
        <input type="text" id="roomType" v-model="formData.roomType" placeholder="Enter room type" />
      </div>

      <div class="form-group">
        <label for="cancellationPolicy">Cancellation policy</label>
        <input type="text" id="cancellationPolicy" v-model="formData.cancellationPolicy"
          placeholder="Enter cancellation policy" />
      </div>

      <div class="form-group">
        <label for="rooms">Rooms</label>
        <input type="number" id="rooms" v-model.number="formData.rooms" placeholder="Enter total number of rooms" />
      </div>

      <div class="form-group">
        <label for="price">Price</label>
        <input type="number" id="price" v-model.number="formData.price" placeholder="Enter room price" />
      </div>
  ...
  methods: {
    ...
    async onSave() {
      try {
        ...
        await axios.post(`${API_BASE_URL}/api/rates`, {
